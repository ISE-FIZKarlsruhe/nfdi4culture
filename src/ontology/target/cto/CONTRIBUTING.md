# Contributing to NFDI4Culture Ontology (CTO)
...
The NFDI4Culture Ontology (CTO) team strives to create a
...
Please use our [Issue Tracker](https://github.com/ISE-FIZKarlsruhe/nfdi4culture/issues/) for reporting problems with the ontology. 
...
Request a new term _via_ the GitHub [Issue Tracker](https://github.com/ISE-FIZKarlsruhe/nfdi4culture/issues/).

It is important to remember that it takes a lot of time for curators to process issues submitted to the tracker.
To make this work easier, please always use issue templates if they are available (https://github.com/ISE-FIZKarlsruhe/nfdi4culture/issues/new/choose).
